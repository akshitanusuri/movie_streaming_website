...
public class PlayVideo extends JFrame {
    ...
    public static final String VID_URL =
            "/home/silla/Downloads/cartoon.mp4";

    private static final int VID_WIDTH     = 1200;
    private static final int VID_HEIGHT    = 1200;
    private static final int PLAYER_WIDTH  = 1200;
    private static final int PLAYER_HEIGHT = 1200;
    ...
    private void initFX(JFXPanel panel, String url) {
       ...
       // Media m = new Media(video_source.toURI().toString());
        MediaView mediaView = createMediaView(video_source.toURI().toString());
